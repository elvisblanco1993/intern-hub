            ...
            <div class="h-full px-4 sm:px-16 md:px-24 lg:px-48">
                <div class="h-full flex items-center max-w-4xl">
                    <div>
                        ...
                        <button class="h-full bg-orange-600 mt-6 inline-block px-8 py-4 rounded-lg uppercase bg-gradient-to-t from-intern to-intern/80 text-white font-bold">Start your search</button>
                    </div>
                </div>
            </div>
        </div>
